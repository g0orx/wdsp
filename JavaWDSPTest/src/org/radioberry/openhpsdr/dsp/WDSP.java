...
public class WDSP {
    ...
    static {
        ...
        if(System.getProperty("os.name").startsWith("Windows")) {
            ...
            String libraryPath2= "C:\\dev\\git\\OpenHPSDR-Thetis\\Project Files\\bin\\x86\\Release";
           ...
           // Log.i("WDSP","load wdsp.dll");
            System.load(libraryPath+File.separator+ "../../../Release/"  + "wdsp.dll");
            //System.load(libraryPath2+File.separator  + "wdsp.dll");
