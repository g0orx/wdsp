...
{
	a->out = (real *) malloc0 (a->size * sizeof (complex));
}
...
SENDER create_sender (int run, int flag, int mode, int size, real* in, int arg0, int arg1, int arg2, int arg3)
{
...
void setBuffers_sender (SENDER a, real* in)
{
	a->in = in;
}
